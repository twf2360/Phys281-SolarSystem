...
Sol = ParticleV2(sunPosition, sunVel, sunAccel , 'Sol', sunMass) 
...
Earth = ParticleV2(earthPosition, earthVel, earthAccel, 'Earth', earthMass)
...
Jupiter = ParticleV2(jupPosition,jupVel, jupAccel, 'Jupiter', jupMass)
...
Venus = ParticleV2(venPosition, venVel, venAccel, 'Venus', venMass)
...
Ganymede = ParticleV2(ganyPosition, ganyVel, ganyAccel, 'Ganymede', ganyMass)
...
Pluto = ParticleV2(plPosition, plVel, plAccel, 'Pluto', plMass)
...
Io = ParticleV2(ioPosition, ioVel, ioAccel, 'Io', ioMass)
...
Mercury = ParticleV2(merPosition, merVel, merAccel, 'Mercury', merMass)
...
Saturn = ParticleV2(saturnPosition, saturnVel, saturnAccel, 'Saturn', saturnMass)
